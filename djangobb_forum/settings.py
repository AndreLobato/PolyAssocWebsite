...
FORUM_META_DESCRIPTION = get('DJANGOBB_FORUM_META_DESCRIPTION', 'Polychaetologists Association Forum')
...
HEADER = get('DJANGOBB_HEADER', 'Polychaetologists Association Forum')
TAGLINE = get('DJANGOBB_TAGLINE', 'The associations of worms friends')
